...
GROUP BY RD.RECEIPTKEY, PA.CASECNT, RD.QTYEXPECTED, RD.QTYRECEIVED, RD.REFERENCEDOCUMENT
)T0 
LEFT JOIN WMWHSE51.STORER AS ST
ON T0.PROVEEDOR = ST.STORERKEY
GROUP BY CODIGOORDEN, CODIGOASN, PROPIETARIO, PROVEEDOR, FECHARECEPCION,CANTIDADRECIBIDA, CANTIDADESPERADA, ST.DESCRIPTION 