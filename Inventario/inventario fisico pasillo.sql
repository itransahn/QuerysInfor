...
,LLI.QTY AS UNIDADES
,LO.LOCATIONTYPE TIPO
,(CASE
WHEN DATEDIFF(DAY,getdate(),vLLI.LOTTABLE05) > SK.SHELFLIFE THEN 'APTO'
WHEN DATEDIFF(DAY,getdate(),vLLI.LOTTABLE05) between 0 and SK.SHELFLIFE THEN 'PRECADUCADO'
WHEN DATEDIFF(DAY,getdate(),vLLI.LOTTABLE05) < 0 THEN 'CADUCADO'
ELSE ''
END  ) as ESTADO
